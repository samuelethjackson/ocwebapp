        ...
        <div className="col-start-4 col-end-13 about flex flex-col gap-20 pt-36 pb-40">
          <div id="about" className="grid grid-cols-10 gap-8">
            ...
            <div className="flex flex-col w-full col-span-10 gap-8">
              <p>
                Oceanic Refractions emerges from a long-standing friendship and
                collaboration between us - AM Kanngieser (Germany/Australia) and
                Mere Nailatikau (Fiji). Beginning in 2018 with an audio
                storytelling class at The University of South Pacific’s Oceania
                Center in Suva, Fiji, we have worked together to centre
                Indigenous Pacific storytelling in climate art and communication
                across the Pacific Islands/Oceania, in Europe and so-called
                Australia. The community radio broadcasting workshops and
                interviews have since developed into a series of commissioned
                documentaries for international broadcast (Listening Across
                Fault Lines, 2023) and a feature exhibition for a European sound
                art biennale (Crenulations—Pacific Drift, 2023), both
                co-produced with Eliki Reade (Australia/Fiji). 
              </p>
              <p>
                Oceanic Refractions was conceived as a multisensory installation
                by AM Kanngieser, Mere Nailatikau, and Eliki Reade. It features
                videography from Laisiasa Dave Lavaki (Fiji), Tumeli Tuqota
                (Fiji) and Mere Nailatikau, and sound design by Joseph Kamaru
                (Kenya/ Berlin) and AM Kanngieser. The European installation is
                built with technical production managers and fabricators Space
                Forms (Ireland), projection specialists FrameWorks (Ireland),
                and olfactory artist Smell Art (Australia).  
              </p>
            </div>
          </div>
          <div id="background" className="grid grid-cols-10 gap-8">
            ...
            <div className="flex flex-col w-full col-span-10 gap-8">
              <p>
                ...
                the everyday lives, practices and world views of Pacific people
                and their environments, bearing witness to ongoing and
              ...
              <p>
                ...
                the privilege of working. In embracing their complexity, we move
              ...
              <p>
                ...
                creators and artists in the Pacific Islands. The western concept
                of Indigeneity holds significant social cachet within artistic
                circles of white settler-coloniser societies, where it is often
                exoticised and patronised. For Indigenous artists residing in
                their home countries without the support of a publicly funded
                arts sector, creative opportunities are frequently limited to
                performative cultural representation and influenced by themes
                imposed by development and aid agencies.
              </p>
              <p>
                Recognising the complex inequities they confront, we
                purposefully showcase Pacific Islands-based creators and artists
                and ensure equitable pay. This commitment is the foundation
                upholding our decision to bring Oceanic Refractions back to the
                region. The project must benefit the communities we work with;
                our plan is to co-design ongoing interactions of the project
                with local communities, creators, and artists on a long-term
                basis and establish a community-led trust to support local
                initiatives without reporting.
              </p>
              <p>
                Our work progresses in close consultation with an Advisory Group
                comprising Joey Tau (Papua New Guinea/ Fiji) from Pacific
                Network on Globalisation - PANG; Fleur Ramsay (Samoa/ Australia)
                from Blue Ocean Law; Indigenous culturalist Simione Sevudredre
                (Fiji); and environmental scientist and curator Sana Balai
                (Bouganville/ Australia). 
              </p>
            </div>
          </div>
          <div id="relationship" className="grid grid-cols-10 gap-8">
            ...
            <div className="flex flex-col w-full col-span-10 gap-8">
              <p>
                ...
                well as possible the vastly differential economic, racial and
                social capital and power between diverse Indigenous and
                non-Indigenous communities. All material in Oceanic Refractions
                has been recorded consensually, in consultation with, and
                invitation by, the speakers and environments. We are explicitly
                dedicated to anti-colonial approaches and the centralisation of
                Indigenous knowledge and relational values. Our actions and
                protocols as Indigenous and non-Indigenous artists are outlined
                in the Oceanic Refractions project philosophy.
              </p>
              <p>
                ...
                Pacific Island countries. It is crucial for Oceanic Refractions
                to extend beyond formalised and exclusive arts spaces.
                Creativity knows no bounds, and we firmly believe that the right
                to enjoy, contribute to, and engage with the arts belongs to
                everyone.
              </p>
              <p>
                ...
                and collaborations with communities and creators in the Pacific
                Islands.
              </p>
              ...
              <ul>
                ...
                <li>
                  Equitably pay collaborators for their time and showcase their
                  contributions, prioritising Pacific Islands-based creators at
                  every opportunity;
                </li>
                <li>
                ...
                <li>
                  Bring the installation to the Pacific region with an emphasis
                  on engaging long-term with communities and schools through
                  workshops, skill-sharing and creative opportunities.
                </li>
              </ul>
              <p>
                We work closely with our Advisory Group to ensure we are always
                accountable to Pacific communities. Our project philosophy
                captures how we commit to working based on our reflections on
                methods, co-design, listening, and emphasising Indigenous
                knowledge and perspectives. 
              </p>
              <p>
                Informed by our individual and collective experiences, we align
                ourselves with people, places and communities that share Oceanic
                Refractions’ ethos and values. Conversely, we refrain from
                engaging with institutions and actors that have shown a lack of
                good faith. Recognising the extractive and colonialist
                frameworks of aid-funded development and academia, both of which
                we have extensive experience in, we make a deliberate choice to
                demote these spaces in our work. 
              </p>
            </div>
          </div>
          <div id="community" className="grid grid-cols-10 gap-8">
            ...
            <div className="flex flex-col w-full col-span-10 gap-8">
              <p>
                ...
                institutions who have contributed to making Oceanic Refractions
                possible. Our gratitude goes to the following for their
                creativity, expertise, goodwill, testimonials and resourcing: 
              </p>
              <ul>
                <li>
                  Lydia Jacob and Philip Tacom (Duke of York Islands, Papua New
                  Guinea), Teweiariki Teaero (Kiribati), Simione Sevudredre and
                  Unaisi Nabobo-Baba (Fiji)
                </li>
                ...
                <li>Olan Clarke</li>
                <li>Joey Tau, Sana Balai, Fleur Ramsay, Simione Sevudredre</li>
          ...
          <div id="philosophies" className="grid grid-cols-10 gap-8">
            ...
            <div className="w-full grid grid-cols-10 col-span-10 gap-8">
              <p>
                As a collective, our shared principles shape why and how we work
                together. These principles guide how we relate to one another
                and how we also hope to relate to project partners. They also
                reflect the prioritisation of integrity and care in our working
                methods.
              </p>
              <h3 className="paragraph-title">
              ...
              <ul>
                <li>
                  ...
                  perspectives and approaches, we are open to finding ways to
                  navigate conflicting viewpoints where possible. However, our
                  priority is to amplify the Indigenous perspective;
                </li>
                <li>
                  We consult with Indigenous partners and collaborators to
                  ensure we have consent and permission to gather material, to
                  make material public, and the use of material is aligned with
                  community protocols;
                </li>
                <li>
                ...
                <li>
                  We will not foreground non-Indigenous presentation partners or
                  funders in our public presentation materials. We will work
                  with non-Indigenous project partners to find alternative ways
                  to respectfully acknowledge their input.
                </li>
              </ul>
              <h3 className="paragraph-title">
              ...
              <p>
                ...
                different ways. This is important to ensure that the work comes
                to rest in its rightful home and that the communities it draws
                from are included in the economies the works generate.
              </p>
              <h3 className="paragraph-title">
                What this looks like in practice:
              </h3>
              <ul>
                ...
                <li>We pay project partners at rates equitable to our own;</li>
                <li>
                  All recordings and material will be properly attributed as
                  desired by project partners;
                </li>
                <li>
                  We work with community Elders and organisations to return the
                  artistic material to the lands they were taken from through
                ...
                <li>
                  We work with communities to make the material relevant to them
                  in the ways they see fit;
                </li>
                <li>
                  We prioritise building long-term relationships of trust and
                  reciprocity, and will follow Pacific protocols for engagement;
                </li>
                <li>
              ...
              <p>
                In order to minimise Western capitalist cultures of urgency and
                stress, we practise clear and direct communication. We do so
                within our team and with project partners.
              </p>
              <h3 className="paragraph-title">
