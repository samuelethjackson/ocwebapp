...
const StorySection = forwardRef<HTMLDivElement, StorySectionProps>(({ video, text, id }, ref) => {
  ...
  return (
    <section
      id={id.toString()}
      ref={ref}
      className={`relative w-screen h-screen md:w-full md:h-full bg-white dark:bg-black md:snap-start grid grid-cols-6 md:grid-cols-24 px-5`}
    >
      {isGif ? (
      ...
      <div className="relative z-10 grid place-items-center h-full col-start-1 col-end-6 max-w-[700px]">
